...
```bash
npx skills@latest add maccalsa/skills --skill=diagnosing-bugs
```
...
- [`SKILL.md`](https://github.com/maccalsa/skills/blob/main/skills/engineering/diagnosing-bugs/SKILL.md)
- Bucket: `engineering`
