...
```bash
npx skills@latest add maccalsa/skills --skill=writing-great-skills
```
...
- [`SKILL.md`](https://github.com/maccalsa/skills/blob/main/skills/productivity/writing-great-skills/SKILL.md)
- Bucket: `productivity`
