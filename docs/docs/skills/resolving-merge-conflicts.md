...
```bash
npx skills@latest add maccalsa/skills --skill=resolving-merge-conflicts
```
...
- [`SKILL.md`](https://github.com/maccalsa/skills/blob/main/skills/engineering/resolving-merge-conflicts/SKILL.md)
- Bucket: `engineering`
